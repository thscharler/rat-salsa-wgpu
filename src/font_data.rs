...
static FALLBACK_DATA: &[u8] = include_bytes!("font_data/CascadiaMono-Regular.ttf");
#[cfg(feature = "fallback_font")]
static FALLBACK_FONT: OnceLock<ratatui_wgpu::Font<'static>> = OnceLock::new();
#[cfg(feature = "fallback_symbol_font")]
static SYMBOL_DATA: &[u8] = include_bytes!("font_data/NotoSansSymbols2-Regular.ttf");
#[cfg(feature = "fallback_symbol_font")]
...
impl FontData {
    ...
    #[cfg(feature = "fallback_font")]
    pub fn fallback_font(self) -> Option<ratatui_wgpu::Font<'static>> {
        Some(
            FALLBACK_FONT
